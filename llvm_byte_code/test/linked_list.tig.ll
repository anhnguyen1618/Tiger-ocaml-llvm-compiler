...
entry:
  ...
  store { i32, i8* }* %d36, { i32, i8* }** %8
  %current_node37 = load { i32, i8* }*, { i32, i8* }** %current_node
  %9 = bitcast { i32, i8* }* %current_node37 to i8*
...
test:                                             ; preds = %loop, %entry
  ...
  %11 = bitcast { i32, i8* }* %current_node38 to i8*
...
loop:                                             ; preds = %test
  ...
  store { i32, i8* }* %13, { i32, i8* }** %current_node
