...
@10 = private unnamed_addr constant [16 x i8] c"bubble_sort.tig\00"
@11 = private unnamed_addr constant [15 x i8] c"Before sorting\00"
@12 = private unnamed_addr constant [15 x i8] c"==============\00"
@13 = private unnamed_addr constant [14 x i8] c"After sorting\00"
@14 = private unnamed_addr constant [48 x i8] c"test/bubble_sort.tig::67.23: Array out of bound\00"
@15 = private unnamed_addr constant [48 x i8] c"test/bubble_sort.tig::68.23: Array out of bound\00"
@16 = private unnamed_addr constant [48 x i8] c"test/bubble_sort.tig::69.23: Array out of bound\00"
@17 = private unnamed_addr constant [48 x i8] c"test/bubble_sort.tig::70.23: Array out of bound\00"
@18 = private unnamed_addr constant [48 x i8] c"test/bubble_sort.tig::71.23: Array out of bound\00"
@19 = private unnamed_addr constant [48 x i8] c"test/bubble_sort.tig::75.23: Array out of bound\00"
@20 = private unnamed_addr constant [48 x i8] c"test/bubble_sort.tig::76.23: Array out of bound\00"
@21 = private unnamed_addr constant [48 x i8] c"test/bubble_sort.tig::77.23: Array out of bound\00"
@22 = private unnamed_addr constant [48 x i8] c"test/bubble_sort.tig::78.23: Array out of bound\00"
@23 = private unnamed_addr constant [48 x i8] c"test/bubble_sort.tig::79.23: Array out of bound\00"
...
entry:
  ...
  call void @tig_print(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @12, i32 0, i32 0))
  call void @bubble_sort({ i32 }* %frame_pointer, { i32, i32* }* %0)
  call void @tig_print(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @13, i32 0, i32 0))
  call void @print_array({ i32 }* %frame_pointer, { i32, i32* }* %0)
  %2 = bitcast { i32, i32* }* %1 to i8*
  call void @tig_check_array_bound(i8* %2, i32 0, i8* getelementptr inbounds ([48 x i8], [48 x i8]* @14, i32 0, i32 0))
  ...
  call void @assert_int({ i32 }* %frame_pointer, i32 %arr_ele, i32 4)
  %3 = bitcast { i32, i32* }* %1 to i8*
  call void @tig_check_array_bound(i8* %3, i32 1, i8* getelementptr inbounds ([48 x i8], [48 x i8]* @15, i32 0, i32 0))
  ...
  call void @assert_int({ i32 }* %frame_pointer, i32 %arr_ele9, i32 3)
  %4 = bitcast { i32, i32* }* %1 to i8*
  call void @tig_check_array_bound(i8* %4, i32 2, i8* getelementptr inbounds ([48 x i8], [48 x i8]* @16, i32 0, i32 0))
  ...
  call void @assert_int({ i32 }* %frame_pointer, i32 %arr_ele14, i32 2)
  %5 = bitcast { i32, i32* }* %1 to i8*
  call void @tig_check_array_bound(i8* %5, i32 3, i8* getelementptr inbounds ([48 x i8], [48 x i8]* @17, i32 0, i32 0))
  ...
  call void @assert_int({ i32 }* %frame_pointer, i32 %arr_ele19, i32 1)
  %6 = bitcast { i32, i32* }* %1 to i8*
  call void @tig_check_array_bound(i8* %6, i32 4, i8* getelementptr inbounds ([48 x i8], [48 x i8]* @18, i32 0, i32 0))
  ...
  call void @assert_int({ i32 }* %frame_pointer, i32 %arr_ele24, i32 0)
  call void @bubble_sort({ i32 }* %frame_pointer, { i32, i32* }* %1)
  %7 = bitcast { i32, i32* }* %1 to i8*
  call void @tig_check_array_bound(i8* %7, i32 0, i8* getelementptr inbounds ([48 x i8], [48 x i8]* @19, i32 0, i32 0))
  ...
  call void @assert_int({ i32 }* %frame_pointer, i32 %arr_ele30, i32 0)
  %8 = bitcast { i32, i32* }* %1 to i8*
  call void @tig_check_array_bound(i8* %8, i32 1, i8* getelementptr inbounds ([48 x i8], [48 x i8]* @20, i32 0, i32 0))
  ...
  call void @assert_int({ i32 }* %frame_pointer, i32 %arr_ele35, i32 1)
  %9 = bitcast { i32, i32* }* %1 to i8*
  call void @tig_check_array_bound(i8* %9, i32 2, i8* getelementptr inbounds ([48 x i8], [48 x i8]* @21, i32 0, i32 0))
  ...
  call void @assert_int({ i32 }* %frame_pointer, i32 %arr_ele40, i32 2)
  %10 = bitcast { i32, i32* }* %1 to i8*
  call void @tig_check_array_bound(i8* %10, i32 3, i8* getelementptr inbounds ([48 x i8], [48 x i8]* @22, i32 0, i32 0))
  ...
  call void @assert_int({ i32 }* %frame_pointer, i32 %arr_ele45, i32 3)
  %11 = bitcast { i32, i32* }* %1 to i8*
  call void @tig_check_array_bound(i8* %11, i32 4, i8* getelementptr inbounds ([48 x i8], [48 x i8]* @23, i32 0, i32 0))
  ...
  call void @assert_int({ i32 }* %frame_pointer, i32 %arr_ele50, i32 4)
  ret i32 0
}
...
define void @bubble_sort({ i32 }*, { i32, i32* }*) local_unnamed_addr {
entry:
  %frame_pointer = alloca { { i32 }* }
  %arg_address = getelementptr { { i32 }* }, { { i32 }* }* %frame_pointer, i32 0, i32 0
  store { i32 }* %0, { i32 }** %arg_address
...
entry:
  ...
  %arg_address = getelementptr { { i32 }* }, { { i32 }* }* %frame_pointer, i32 0, i32 0
  store { i32 }* %0, { i32 }** %arg_address
  call void @assert_equal_int(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @10, i32 0, i32 0), i32 %1, i32 %2)
  ret void
}
