...
entry:
  ...
  call void @quick_sort({ i32 }* %frame_pointer, { i32, i32* }* %arr_test25)
...
loop11:                                           ; preds = %test10
  ...
  %load_left = load { i32, i32* }*, { i32, i32* }** %arr
  %1 = bitcast { i32, i32* }* %load_left to i8*
  call void @tig_check_array_bound(i8* %1, i32 %i17, i8* getelementptr inbounds ([47 x i8], [47 x i8]* @14, i32 0, i32 0))
  %array_addr_ptr = getelementptr { i32, i32* }, { i32, i32* }* %load_left, i32 0, i32 1
  %arr_addr = load i32*, i32** %array_addr_ptr
  %arr_ele_addr = getelementptr i32, i32* %arr_addr, i32 %i17
...
entry:
  ...
  call void @assert_equal_int(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @15, i32 0, i32 0), i32 %actual1, i32 %expected2)
  ret void
}
