...
@15 = private unnamed_addr constant [15 x i8] c"quick_sort.tig\00"
...
@23 = private unnamed_addr constant [47 x i8] c"test/quick_sort.tig::83.23: Array out of bound\00"
...
@28 = private unnamed_addr constant [47 x i8] c"test/quick_sort.tig::91.23: Array out of bound\00"
...
entry:
  ...
  call void @tig_check_array_bound(i8* %2, i32 0, i8* getelementptr inbounds ([47 x i8], [47 x i8]* @19, i32 0, i32 0))
  ...
  call void @tig_check_array_bound(i8* %3, i32 1, i8* getelementptr inbounds ([47 x i8], [47 x i8]* @20, i32 0, i32 0))
  ...
  call void @tig_check_array_bound(i8* %4, i32 2, i8* getelementptr inbounds ([47 x i8], [47 x i8]* @21, i32 0, i32 0))
  ...
  call void @tig_check_array_bound(i8* %5, i32 3, i8* getelementptr inbounds ([47 x i8], [47 x i8]* @22, i32 0, i32 0))
  ...
  call void @tig_check_array_bound(i8* %6, i32 4, i8* getelementptr inbounds ([47 x i8], [47 x i8]* @23, i32 0, i32 0))
...
define void @quick_sort({ i32 }*, { i32, i32* }*) local_unnamed_addr {
entry:
...
define i32 @partition({ { i32 }*, { i32, i32* }* }*, i32, i32) local_unnamed_addr {
entry:
  %frame_pointer = alloca { { { i32 }*, { i32, i32* }* }* }
  %arg_address = getelementptr { { { i32 }*, { i32, i32* }* }* }, { { { i32 }*, { i32, i32* }* }* }* %frame_pointer, i32 0, i32 0
...
merge:                                            ; preds = %else, %then
  %wall_index.1 = phi i32 [ %add_tmp, %then ], [ %wall_index.0, %else ]
  %add_tmp61 = add i32 %i.0, 1
  br label %test
}

define void @sort({ { i32 }*, { i32, i32* }* }*, i32, i32) local_unnamed_addr {
entry:
  %frame_pointer = alloca { { { i32 }*, { i32, i32* }* }* }
  %arg_address = getelementptr { { { i32 }*, { i32, i32* }* }* }, { { { i32 }*, { i32, i32* }* }* }* %frame_pointer, i32 0, i32 0
  store { { i32 }*, { i32, i32* }* }* %0, { { i32 }*, { i32, i32* }* }** %arg_address
...
entry:
  ...
  %arg_address = getelementptr { { i32 }* }, { { i32 }* }* %frame_pointer, i32 0, i32 0
  store { i32 }* %0, { i32 }** %arg_address
  call void @assert_equal_int(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @15, i32 0, i32 0), i32 %1, i32 %2)
  ret void
}
