...
entry:
  ...
  store i8* getelementptr inbounds ([6 x i8], [6 x i8]* @1, i32 0, i32 0), i8** %Element
  ...
  store i8* getelementptr inbounds ([6 x i8], [6 x i8]* @0, i32 0, i32 0), i8** %Element5
  ...
  call void @assert_equal_string(i8* %field_var10, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @0, i32 0, i32 0))
  ...
  call void @assert_equal_string(i8* %field_var35, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @1, i32 0, i32 0))
  %element_left37 = getelementptr { i8*, i32 }, { i8*, i32 }* %record_init, i32 0, i32 0
  store i8* getelementptr inbounds ([4 x i8], [4 x i8]* @2, i32 0, i32 0), i8** %element_left37
  ...
  call void @assert_equal_string(i8* %field_var47, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @2, i32 0, i32 0))
  ret i32 0
}
